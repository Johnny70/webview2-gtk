...
print_hint() {
	...
	if [[ -f "${ROOT}/build-remote/add-cookie-changed-smoke.log" ]]; then
		echo "--- add-cookie-changed-smoke.log ---"
		cat "${ROOT}/build-remote/add-cookie-changed-smoke.log"
	fi
	if [[ -f "${ROOT}/build-remote/add-cookie-replace-startup-smoke.log" ]]; then
		echo "--- add-cookie-replace-startup-smoke.log ---"
		cat "${ROOT}/build-remote/add-cookie-replace-startup-smoke.log"
	fi
	if [[ -f "${ROOT}/build-remote/add-cookie-persist-smoke.log" ]]; then
		echo "--- add-cookie-persist-smoke.log ---"
		cat "${ROOT}/build-remote/add-cookie-persist-smoke.log"
	fi
	if [[ -f "${ROOT}/build-remote/add-cookie-proxy-direct-smoke.log" ]]; then
		echo "--- add-cookie-proxy-direct-smoke.log ---"
		cat "${ROOT}/build-remote/add-cookie-proxy-direct-smoke.log"
	fi
	if [[ -f "${ROOT}/build-remote/add-cookie-proxy-smoke.log" ]]; then
		echo "--- add-cookie-proxy-smoke.log ---"
		cat "${ROOT}/build-remote/add-cookie-proxy-smoke.log"
	fi
...
case "${cmd}" in
	...
	add-cookie)
		...
		ssh -o BatchMode=yes "${REMOTE_HOST}" \
			"C:\\msys64\\msys2_shell.cmd -defterm -no-start -ucrt64 -c \"cp -f /c/Users/Alan/AppData/Local/Temp/webview2gtk-add-cookie-smoke.log /c/msys64/tmp/webview2-gtk/build/add-cookie-smoke.log 2>/dev/null || true; cp -f /c/Users/Alan/AppData/Local/Temp/webview2gtk-add-cookie-mirror-smoke.log /c/msys64/tmp/webview2-gtk/build/add-cookie-mirror-smoke.log 2>/dev/null || true; cp -f /c/Users/Alan/AppData/Local/Temp/webview2gtk-add-cookie-changed-smoke.log /c/msys64/tmp/webview2-gtk/build/add-cookie-changed-smoke.log 2>/dev/null || true; cp -f /c/Users/Alan/AppData/Local/Temp/webview2gtk-add-cookie-replace-startup-smoke.log /c/msys64/tmp/webview2-gtk/build/add-cookie-replace-startup-smoke.log 2>/dev/null || true; cp -f /c/Users/Alan/AppData/Local/Temp/webview2gtk-add-cookie-persist-smoke.log /c/msys64/tmp/webview2-gtk/build/add-cookie-persist-smoke.log 2>/dev/null || true; cp -f /c/Users/Alan/AppData/Local/Temp/webview2gtk-add-cookie-proxy-smoke.log /c/msys64/tmp/webview2-gtk/build/add-cookie-proxy-smoke.log 2>/dev/null || true; cp -f /c/Users/Alan/AppData/Local/Temp/webview2gtk-add-cookie-proxy-direct-smoke.log /c/msys64/tmp/webview2-gtk/build/add-cookie-proxy-direct-smoke.log 2>/dev/null || true\"" \
			|| true
		pull_artifacts || true
		print_hint
		exit "${build_rc}"
